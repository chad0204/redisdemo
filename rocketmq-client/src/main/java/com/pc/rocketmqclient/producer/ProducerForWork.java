 ...
 */
@Component
public class ProducerForWork {
    private static Logger logger = LoggerFactory.getLogger(ProducerForWork.class);
    ...
    public void init() {
        ...
        producer = new DefaultMQProducer("c_pay_ccb-brhid_self");

        String namesrvAddr = "mq101.2dfire-daily.com:9876;mq102.2dfire-daily.com:9876";
    ...
    public SendResult sendPay(String topic, String tagName, String msgContent) throws InterruptedException, RemotingException, MQClientException {
        try {
    ...
    public static byte[] transferObjectToByte(Object obj) {
        byte[] bytes = null;
        try {
            // object to bytearray
